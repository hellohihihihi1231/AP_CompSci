...
class starter {
	public static void main(String args[]) {
		...
		System.out.println(Cipher.keyedEncode(Cipher.keyedEncode("549q94u8 q3t sxys0u3 q7u 2e vqb47y9u bq7yqr1u 3q2u8", 13), 29));
		...
		//take in input and encode it
		Scanner in = new Scanner(System.in);
		System.out.print("enter a message you would like to encode: ");
		String encodedMessage = Cipher.encode(in.nextLine());
		//prints out encoded message
		System.out.println(encodedMessage);
		//prints out original message
		System.out.println(Cipher.encode(encodedMessage));
	}
}
